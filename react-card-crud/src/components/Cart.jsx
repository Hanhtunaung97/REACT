...
const Cart = ({ cart: { id, title, price, image, quantity, cost } }) => {
  const { deleteCarts, updateCarts } = useContext(dataContext);
  ...
  const updateSubCartBtn = () => {
    quantity >1 && updateCarts(id, -1);
  };
      ...
      <div className="w-full mb-5">
        ...
        <div className="border bg-white border-neutral-600 p-3 relative">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex">
              <button onClick={updateSubCartBtn} className="bg-neutral-300 duration-100 active:scale-90 cart-item-quantity-decrement p-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <button onClick={updateAddCartBtn} className="bg-neutral-300 duration-100 active:scale-90 cart-item-quantity-increment p-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
