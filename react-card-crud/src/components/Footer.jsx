...
const Footer = () => {
 ...
 <div className="flex justify-between items-center">
      <p className="font-heading">
        Copy Right ©
        <a className="text-neutral-300" href="https://mms-it.com">MMS IT</a>
      </p>
      <a href="#headerSpacer" className="border border-neutral-200 h-12 w-12 flex justify-center items-center">
